<script lang="ts">
    ...
    import ContactForm from "$lib/components/ui/contact-form/ContactForm.svelte";
    import { Footer } from "$lib/components/ui/footer/index.js"

    export let data: PageData;
</script>

<section class="bg-slate-200 dark:bg-zinc-800 font-sans mb-96">
    <div class="">
        <div class="bg-no-repeat bg-cover bg-center relative bg-cyan-700 bg-blend-multiply" style="background-image: url('/src/lib/images/contact.jpg')">
            <div class="px-4 lg:pt-24 pt-8 pb-64 lg:pb-80 mx-auto max-w-screen-sm text-center lg:px-6">
                    <h2 class="mb-4 text-4xl tracking-tight font-black text-white antialiased">Contact Us</h2>
                    <p class="mb-24 font-medium text-white sm:text-2xl">Reach out and let's get started.  We'll protect your IP while you grow your brand.</p>
            </div> 
        </div>
    </div>
    <div class="px-4 mx-auto max-w-screen-xl z-10 flex justify-center">
        <div class="absolute mx-auto"><ContactForm data={data.form}></ContactForm></div>
